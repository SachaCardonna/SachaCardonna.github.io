...
- $\mathbb{P}^1$ ALE wave run-up over a sloping beach generated by an impulsively stopped piston ([AVI]({{ site.baseurl }}/images/spring_beach.gif))
<!-- - $\mathbb{P}^2$ Periodic wave generation by an oscillating piston ([AVI]({{ site.baseurl }}/images/spring_ale.gif)) -->
