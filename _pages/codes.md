...
<section class="wavebox-gallery" aria-label="WaveBox numerical simulations">
  ...
  <div class="wavebox-gallery__select-wrap">
    <select id="wavebox-select" class="wavebox-gallery__select">
      <option value="{{ site.baseurl }}/images/single_wave_cylinder_moving.avi" data-type="video" data-degree="P³ · 2D">Single wave interacting with a heaving cylinder</option>
  ...
  <div class="wavebox-gallery__stage" id="wavebox-stage" aria-live="polite">
    <video src="{{ site.baseurl }}/images/surge_heave_pitch_single.avi" controls preload="metadata" playsinline aria-label="Single wave interacting with a heaving-surging-pitching pontoon simulation"></video>
  </div>

  <div class="wavebox-gallery__footer">
    <div class="wavebox-gallery__caption">
      <span id="wavebox-meta">P² · ALE 2D</span>
      <strong id="wavebox-caption">Single wave interacting with a heaving-surging-pitching pontoon</strong>
    </div>
