...
<section class="wavebox-gallery" aria-label="WaveBox numerical simulations">
  ...
  <div class="wavebox-gallery__select-wrap">
    <select id="wavebox-select" class="wavebox-gallery__select">
      <option value="{{ site.baseurl }}/images/single_wave_cylinder_moving.avi" data-type="video" data-degree="P³ · 2D">Single wave interacting with a moving cylinder</option>
      <option value="{{ site.baseurl }}/images/return_equilibrium_cylinder.avi" data-type="video" data-degree="P³ · 2D">Cylinder returning to equilibrium</option>
      <option value="{{ site.baseurl }}/images/cylindrical_wave_generator_rectangle.avi" data-type="video" data-degree="P² · 2D">Cylindrical wave generator on a rectangular mesh</option>
      <option value="{{ site.baseurl }}/images/cylindrical_wave_generator_circle.avi" data-type="video" data-degree="P³ · 2D">Cylindrical wave generator on a circular mesh</option>
      <option value="{{ site.baseurl }}/images/pontoon_release_ale.avi" data-type="video" data-degree="P¹ · ALE 2D">Pontoon released with an initial velocity</option>
      <option value="{{ site.baseurl }}/images/horizontal_prescribed_ale_pontoon.avi" data-type="video" data-degree="P² · ALE 2D">Pontoon with prescribed horizontal ALE motion</option>
      <option value="{{ site.baseurl }}/images/single_wave_pontoon_ale.avi" data-type="video" data-degree="P² · ALE 2D">Single wave interacting with an ALE pontoon (1)</option>
      <option value="{{ site.baseurl }}/images/single_wave_pontoon_ale_P5.avi" data-type="video" data-degree="P⁵ · ALE 2D">Single wave interacting with an ALE pontoon (2)</option>
  ...
  <div class="wavebox-gallery__stage" id="wavebox-stage" aria-live="polite">
    <video src="{{ site.baseurl }}/images/single_wave_cylinder_moving.avi" controls preload="metadata" playsinline aria-label="Single wave interacting with a moving cylinder simulation"></video>
  </div>

  <div class="wavebox-gallery__footer">
    <div class="wavebox-gallery__caption">
      <span id="wavebox-meta">P³ · 2D</span>
      <strong id="wavebox-caption">Single wave interacting with a moving cylinder</strong>
    </div>
...
<div class="media-strip" style="justify-content: space-between;">
      <img src="{{ site.baseurl }}/images/shorevpinn1.gif" alt="WaveBox Image 2" style="width: 52.7%; height: auto;">
      <img src="{{ site.baseurl }}/images/shorevpinn3.gif" alt="WaveBox Image 1" style="width: 45.3%; height: auto;">
</div>
</section>
