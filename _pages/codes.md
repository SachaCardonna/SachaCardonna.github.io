...
- $\mathbb{P}^1$ ALE translating and oscillating cylinder in a shallow-water flow ([AVI_1]({{ site.baseurl }}/images/ale_dual.avi) & [AVI_1]({{ site.baseurl }}/images/oscillating_cylinder.avi))
