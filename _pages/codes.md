...
- $\mathbb{P}^1$ ALE wave run-up over a sloping beach generated by an impulsively stopped piston ([AVI]({{ site.baseurl }}/images/spring_beach.avi))
- $\mathbb{P}^2$ ALE periodic wave generation by an oscillating piston ([MP4]({{ site.baseurl }}/images/spring_ale.mp4))
- $\mathbb{P}^1$ ALE translating and oscillating cylinder in a shallow-water flow ([AVI_1]({{ site.baseurl }}/images/ale_dual.avi) & [AVI_2]({{ site.baseurl }}/images/oscillating_cylinder.avi))
