...
- During [MIPS Week](https://www.umontpellier.fr/agenda/semaine-du-pole-mips), I presented some aspects of modeling and scientific computing to non-experts scientists, see the [slides]({{ site.url }}/files/talks/MIPS.pdf). 
