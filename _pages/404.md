...
<script>
    const contents = [
        ...
        <button onclick="document.getElementById('audioPlayer').play()" 
                style="background-color:rgb(0, 0, 0); color: white; border: none; padding: 10px 20px; font-size: 16px; border-radius: 5px; cursor: pointer;">
            Moi je crois qu'aux mathématiques ♫
        </button>
        <audio id="audioPlayer" loop>
        ...
        `
        <img src="/files/misc/mgs.gif" alt="Outer Heaven">
        <br> <br>
        <button onclick="document.getElementById('audioPlayer').play()" 
                style="background-color:rgb(0, 0, 0); color: white; border: none; padding: 10px 20px; font-size: 16px; border-radius: 5px; cursor: pointer;">
        ...
        <audio id="audioPlayer" loop>
          <source src="/files/misc/calling_to_the_night.mp3" type="audio/mpeg">
        </audio>
        <br> <br>
        <strong>Game</strong>: <em>Metal Gear Solid V: The Phantom Pain</em> - Konami <br>
        <strong>Music</strong>: <em>Calling to the Night</em> - Natasha Farrow
        `,

        `
        <img src="/files/misc/marty.gif" alt="Top">
        <br> <br>
        <button onclick="document.getElementById('audioPlayer').play()" 
                style="background-color:rgb(0, 0, 0); color: white; border: none; padding: 10px 20px; font-size: 16px; border-radius: 5px; cursor: pointer;">
            I have a purpose ♫
        ...
        <audio id="audioPlayer" loop>
          <source src="/files/misc/everybody.mp3" type="audio/mpeg">
        </audio>
        <br> <br>
        <strong>Movie</strong>: <em>Marty Supreme</em> - Josh Safdie <br>
        <strong>Music</strong>: <em>Everybody Wants to Rule the World</em> - Tears for Fears
        `
    ];
