...
Solutions of some exercise sheets: 
 - Parametric Curves ([Solutions]({{ site.url }}/files/teaching/HA8401H/TD2_Exo_6.pdf))
 - Geometry and Topology in $\mathbb{R}^n$ ([Solutions]({{ site.url }}/files/teaching/HA8401H/TD3_correction.pdf))
 - Differential Calculus ([Solutions]({{ site.url }}/files/teaching/HA8401H/TD4_correction.pdf))
 - Multiple Integrals ([Solutions]({{ site.url }}/files/teaching/HA8401H/TD5.1_correction.pdf))
